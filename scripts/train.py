...
class ESDConfig:
    ...
    model_type: str = "UNetxx"
    tile_size_gt: int = 4
    batch_size: int = 8
    max_epochs: int = 20 # 40 was overfitting
    seed: int = 12378921
    #learning_rate: float = 1e-4
    learning_rate: float = 0.0002924 # from sweep 3.3; best results for val acc
    #learning_rate: float= 0.0007232 #from sweep 3.7, had lowest val loss
    num_workers: int = 11
